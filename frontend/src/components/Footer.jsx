...
<div className="space-y-9 grid grid-cols-1 md:grid-cols-2 md:pl-24 md:pr-16 lg:grid-cols-4 lg:px-7 xl:px-14 xl:ml-16">
    ...
    <div className="text-[#747474] text-[15px] font-[550] leading-7 tracking-wide md:">
        ...
        <p>28 Dec 2021</p>
        <p>27 May 2022</p>
        <p>23 Dec 2021 to 27 May 2022</p>
    </div>
        ...
        <div className="text-[#747474] text-[15px] font-[550] leading-7 tracking-wide">
            <div className="flex justify-start">
                <h1
                    ...
                    About </h1> <span className="text-white font-sans uppercase font-normal tracking-wider">US</span>
            </div>
            <p className=""> <a className="hover:text-[#cacaca]" href="#"></a> </p>
            <p className=""> <a className="hover:text-[#cacaca]" href="#"></a> </p>
            <p className=""> <a className="hover:text-[#cacaca]" href="#"></a> </p>
            <p className=""> <a className="hover:text-[#cacaca]" href="#"></a> </p>
        </div>
        <div
            ...
            <div className="flex justify-start md:-mt-32">
                <h1
                    ...
                    support </h1> <span className="text-white font-sans uppercase font-normal tracking-wider">t</span>
            </div>
    ...
    <div className="text-[#797878] text-[15px] font-[550] leading-6 tracking-wide md:order-4 lg:">
        ...
        <p className="space-x-3"> <i className="fa fa-home text-[17px]"></i><strong
                className="text-[#8b8b8b] text-[15px] tracking-wide">CXINU</strong> </p>
        <div className="leading-7">
            <p className=""> uchi building ke niche <br /> Udta Punjab, Canada<br /> Helpline
                No:+91 987-6XXXXX </p>
        </div>
        {/* <div className="leading-7 mt-4 text-[15px] font-[500]">
            ...
            <p className="space-x-3 hover:text-[#cacaca]"> <i className="fa fa-phone text-[17px]"></i> <a
                    href="#">9946948645 ( <span className="text-[13px] font-[500]">General Enquiry</span> )</a> </p>
            <p className="space-x-3 hover:text-[#cacaca]"> <i className="fa fa-phone text-[17px]"></i> <a
                    href="#">9946947005&nbsp;( <span className="text-[13px] font-[500]">Support</span> )
                </a> </p>
